  ...
  "expected_output_files": ["results/metrics.json", "results/training_log.csv", "checkpoints/best_model.pt"]
    ...
    async def _generate_file(
        ...
        system_prompt = (
            ...
            "HARD REQUIREMENT: You MUST forcefully select CUDA if available `device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')`. Do NOT hardcode 'cpu'.\n"
            "Keep your code clean, modular, and directly executable."
