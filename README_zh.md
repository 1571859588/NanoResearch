...
- [核心亮点](#核心亮点真正跑实验的-ai-科研系统)
- [为什么选择 NanoResearch](#为什么选择-nanoresearch)
- [使用场景](#使用场景)
- [成果展示](#成果展示)
- [流水线](#流水线)
- [核心能力](#核心能力)
...
IDEATION → PLANNING → SETUP → CODING → EXECUTION → ANALYSIS → FIGURE_GEN → WRITING → REVIEW
  ↓
导出工作空间：paper.pdf / paper.tex / references.bib / figures / code / data
```
...
如果 NanoResearch 对您的工作有帮助，请引用本仓库：
